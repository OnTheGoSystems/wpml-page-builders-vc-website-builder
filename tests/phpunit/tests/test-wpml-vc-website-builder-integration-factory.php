...
/**
 * Class Test_WPML_VC_Website_Builder_Integration_Factory
 *
 ...
 * @group wpmlcore-5165
 */
class Test_WPML_VC_Website_Builder_Integration_Factory extends OTGS_TestCase {
	...
	public function it_creates() {
		...
		$bb_factory = new WPML_VC_Website_Builder_Integration_Factory();
